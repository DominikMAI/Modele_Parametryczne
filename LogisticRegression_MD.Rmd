---
title: "Wyznaczanie wielkości składki ubezbieczenia z wykorzystaniem uogólnionych modeli liniowych"
...
for (i in seq(1,100,1)){
  ...
  #print(sum(roc_df$recall[-1] * diff(1 - roc_df$specifity)))
...
```
```{r}
print(paste(alpha*100,'% przedział ufności miary AUC:', 
