...
Zmienna **CAR_USE** nie zostaje włączona do modelu, jej właczenie pozwala na obniżenie kryterium informacyjnego o 170.42 jednostek.
...
Wykorzystanie zmiennej charakteryzującej jednostkę osadniczą pozwoliło uzyskać model, który uzyskał wartość kryterium Akaike o 597 punktów niższą względem najlepszego dotychczasowego modelu.
...
```
Model ma tendencje do popełniania błędów fałszywie pozytywnych co oznacza, że model jest nadmiernie czuły na klase negatywną.
...
df[1,] = c(error, accuracy, precision, specifity,ppv,npv)
df
```
