...
for (c in cols[5:length(cols)]){
  ...
  if (w_test$`Pr(>F)`[2] < 0.05){
      print(paste('istotna',c ,'pvalue:', round(w_test$`Pr(>F)`[2], 6) ))
...
```
W iteracyjnej weryfikacji istotności zmiennych, mające wpływ na na liczbę kolizji okazały sie:`istotne`
